...
public class BehaviorsActivity extends Activity
		implements android.os.Handler.Callback
{
	...
	public final static String TAG = "**SB Behaviors**";
	 ...
	 */
	public BehaviorsActivity()
	{
		Log.d(TAG,"BehaviorsActivity()");
	...
	public synchronized void startConnection ()
	{
		synchronized (this)
		{
			...
			// debug parameters
			_roboCOM.msgHello="Start Connection Beha";
	...
	public synchronized void stopConnection (boolean bbUserNotify)
	{
		synchronized (this)
		{
			...
			_roboCOM.sendMessageToServer("End Connection Beha");
			{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.d(TAG,"Creating the Behaviors layout..");
		setContentView(R.layout.behaviors_layout);
	...
	public boolean handleMessage(Message msg) 
	{
		...
		case MSG_NEWSTATUSMESSAGE:	
		{
			if (msg.arg2==uitoken)
			{
				...
				Log.e(TAG,"Status Message Beha : " + (String)msg.obj);
			}
			return true;
		}
	...
	private synchronized void UI_RefreshConnStatus ()
	{
		...
		Log.e(TAG, "Is conection Active Beha : " + isConnectionActive());
		...
		if (used!=null)
		{
			if (old_conn_status!=used.getConnStatus())
			{
				...
				Log.e(TAG,"Connections Status Beha : " + used.getConnStatusStr());
			}
		}
	}
