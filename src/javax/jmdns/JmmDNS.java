 ...
 * </p>
 * Uses an underlying {@link JmDNS} instance for each {@link InetAddress} found
 * on this computer.<br/>
 * This class will monitor network topology changes, and will create or destroy
 * JmDNS instances as required. It is your responsibility to maintain services
 * registration (hint: use a {@link NetworkTopologyListener}).<br/>
 * Most of this class methods have no notion of transaction: if an Exception is
...
public interface JmmDNS extends Closeable {
	...
	public static final class Factory {
		...
		/**
		 * This interface defines a delegate to the EOClassDescriptionRegister
	 ...
	 * will block until updated information is received on all DNS.
	 * <p/>
	 ...
	 * @return list of service info. If no service info is found the list is
	 *         empty.
	 ...
	 */
	public abstract void addNetworkTopologyListener(
			NetworkTopologyListener listener);
	 ...
	 *            listener for network changes
	 */
	public abstract void removeNetworkTopologyListener(
			NetworkTopologyListener listener);
