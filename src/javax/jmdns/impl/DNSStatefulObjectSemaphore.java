...
/**
 * This class define a semaphore. On this multiple threads can wait the arrival
 * of one event. Thread wait for a maximum defined by the timeout.
 * <p>
 * Implementation note: this class is based on
 * {@link java.util.concurrent.Semaphore} so that they can be released by the
 * timeout timer.
 * </p>
 * 
...
public class DNSStatefulObjectSemaphore {
	...
	private static final Timer _timer = new Timer("State Semaphore Timeout",
			true);
	...
	private static final class Entry {
		...
		public String toString() {
			return "Semaphore: " + this._semaphore + " timeout: "
					+ (this._expiry - System.currentTimeMillis());
		}
	}
	...
	public void waitForEvent(long timeout) {
		long end = (timeout > 0 ? System.currentTimeMillis() + timeout
				: Long.MAX_VALUE);
