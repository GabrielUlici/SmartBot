...
/**
 * This class is used to resolve the list of Internet address to use when
 * attaching JmDNS to the network.
 * <p>
 ...
 * }
 * 
 * public static class MyClass implements
...
public interface NetworkTopologyDiscovery {
	...
	public static final class Factory {
		 ...
		 * NetworkTopologyDiscovery.Factory class to enable subclassing.
		 */
		...
		protected static NetworkTopologyDiscovery newNetworkTopologyDiscovery() {
			...
			return (instance != null ? instance
					: new NetworkTopologyDiscoveryImpl());
		}
		...
		public static NetworkTopologyDiscovery getInstance() {
			if (_instance == null) {
				synchronized (NetworkTopologyDiscovery.Factory.class) {
					if (_instance == null) {
						_instance = NetworkTopologyDiscovery.Factory
